...
class BLE_packet_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ble_plot_iq_from_pmt_0 = ble.plot_iq_from_pmt(samp_rate)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ble_tagged_iq_to_vector_0, 'out'), (self.ble_plot_iq_from_pmt_0, 'in'))
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.ble_tag_iq_stream_0, 0))
