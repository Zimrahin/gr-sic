...
class sic_rx_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "sic_rx_test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("sic_rx_test")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "sic_rx_test")
        ...
        self.trigger_delay = trigger_delay = 500E-6
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, (samp_rate/100/2), True, 0 if "auto" == "auto" else max( int(float(0.1) * (samp_rate/100/2)) if "auto" == "time" else int(0.1), 1) )
        self.blocks_sub_xx_0 = blocks.sub_ff(1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/diego/Documents/GNU_radio_OOT_modules/gr-sic/examples/data/BLE_802154_0dBm_8dBm_0MHz.dat', True, 0, 0)
        ...
        self.connect((self.digital_symbol_sync_xx_0, 0), (self.ble_ieee802154_packet_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_throttle2_0.set_sample_rate((self.samp_rate/100/2))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, (self.tuning_LPF_cutoff_kHz*1000), (self.samp_rate/50), window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=sic_rx_test, options=None):
